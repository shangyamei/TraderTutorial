...
35. k线技术：帮助找到回调后的入场点，打赌趋势恢复。一般趋势会在2-3波后恢复，如果趋势恢复失败的话，可能会再走一个2-3波的回撤，然后趋势恢复。这两次2-3波的回撤共计4-6波回撤
    ![alt text](pic/image-12.png)
36. K线计数用于计算回调中的走势段数量，同时三角形是一种回调
    ![alt text](pic/image-11.png)
37. 多头行情的回调，如果存在4次甚至更多的回调腿，那么更有可能是反转
